...
static AVPMENU_ELEMENT AvPMenu_MainMenu[] =
{
	...
	{AVPMENU_ELEMENT_GOTOMENU, TEXTSTRING_MAINMENU_GAMEPLAYOPTIONS,		AVPMENU_CONTROLOPTIONS},
...
static AVPMENU_ELEMENT AvPMenu_MainMenu[] =
{
	...
	{AVPMENU_ELEMENT_GOTOMENU, {TEXTSTRING_MAINMENU_OPTIONS},	{AVPMENU_OPTIONS},{0},{0},				TEXTSTRING_MAINMENU_OPTIONS_HELP},
	//{AVPMENU_ELEMENT_GOTOMENU, {TEXTSTRING_MAINMENU_GAMEPLAYOPTIONS},	{AVPMENU_CONTROLOPTIONS},{0},{0},				TEXTSTRING_MAINMENU_GAMEPLAYOPTIONS_HELP},
	...
	//{AVPMENU_ELEMENT_GOTOMENU, {TEXTSTRING_MAINMENU_ACHIEVEMENTS},		{AVPMENU_ACHIEVEMENTS},{0},{0},			TEXTSTRING_MAINMENU_ACHIEVEMENTS_HELP},
...
{
	{AVPMENU_ELEMENT_GOTOMENU_GFX,	{/*AVPMENUGFX_ALIEN_LOGO*/0},		{AVPMENU_ALIEN_GAMETYPE},{0},{0},		TEXTSTRING_MAINMENU_SINGLEPLAYER_ALIEN},
	{AVPMENU_ELEMENT_GOTOMENU_GFX,	{/*AVPMENUGFX_MARINE_LOGO*/0},		{AVPMENU_MARINE_GAMETYPE},{0},{0},		TEXTSTRING_MAINMENU_SINGLEPLAYER_MARINE},
	{AVPMENU_ELEMENT_GOTOMENU_GFX,	{/*AVPMENUGFX_PREDATOR_LOGO*/0},	{AVPMENU_PREDATOR_GAMETYPE},{0},{0},	TEXTSTRING_MAINMENU_SINGLEPLAYER_PREDATOR},
	//	{AVPMENU_ELEMENT_GOTOMENU,		{TEXTSTRING_MAINMENU_TITLE},	{AVPMENU_MAIN}},
		{AVPMENU_ELEMENT_ENDOFMENU}
};

static AVPMENU_ELEMENT AvPMenu_MouseControlsOptions[] =
{
...
static AVPMENU_ELEMENT AvPMenu_Marine_Custom_Levels[] =
{
	{AVPMENU_ELEMENT_MARINECUSTOMEPISODE, { TEXTSTRING_MULTIPLAYER_ENVIRONMENT }, { 99 }, { &MP_LevelNumber }, { TEXTSTRING_MULTIPLAYERLEVELS_1 } },
	{AVPMENU_ELEMENT_ENDOFMENU}
};
...
static AVPMENU_ELEMENT AvPMenu_Alien_Custom_Levels[] =
{
	{AVPMENU_ELEMENT_ALIENCUSTOMEPISODE, { TEXTSTRING_MULTIPLAYER_ENVIRONMENT }, { 99 }, { &MP_LevelNumber }, { TEXTSTRING_MULTIPLAYERLEVELS_1 } },
	{AVPMENU_ELEMENT_ENDOFMENU}
};
...
static AVPMENU_ELEMENT AvPMenu_Predator_Custom_Levels[] =
{
	{AVPMENU_ELEMENT_PREDATORCUSTOMEPISODE, { TEXTSTRING_MULTIPLAYER_ENVIRONMENT }, { 99 }, { &MP_LevelNumber }, { TEXTSTRING_MULTIPLAYERLEVELS_1 } },
	{AVPMENU_ELEMENT_ENDOFMENU}
};
...
AVPMENU_ELEMENT AvPMenu_Skirmish_Config_NoGold[] =
{
	{AVPMENU_ELEMENT_RESETMPCONFIG,	{TEXTSTRING_CONTROLS_RESETTODEFAULT},	{0},	{0},	{TEXTSTRING_BLANK},	TEXTSTRING_CONTROLS_RESETTODEFAULT_HELP},
	{AVPMENU_ELEMENT_GOTOMENU,	{TEXTSTRING_MULTIPLAYER_LOADCONFIG},	{AVPMENU_MULTIPLAYER_LOADCONFIG},	{0},	{TEXTSTRING_BLANK},	TEXTSTRING_MULTIPLAYER_LOADCONFIG_HELP},
	{AVPMENU_ELEMENT_GOTOMENU,	{TEXTSTRING_MULTIPLAYER_SAVECONFIG},	{AVPMENU_MULTIPLAYER_SAVECONFIG},	{0},	{TEXTSTRING_BLANK},	TEXTSTRING_MULTIPLAYER_SAVECONFIG_HELP},
...
static AVPMENU_ELEMENT AvPMenu_InGame[] =
{
	...
	{AVPMENU_ELEMENT_GOTOMENU,    {TEXTSTRING_MOUSECONTROLS_TITLE},			{AVPMENU_MOUSECONTROLS}},
...
static AVPMENU_ELEMENT AvPMenu_ControlOptions[] =
{
	{AVPMENU_ELEMENT_GOTOMENU,	{TEXTSTRING_MOUSECONTROLS_TITLE},		{AVPMENU_MOUSECONTROLS},			{0},	{0},	TEXTSTRING_MOUSECONTROLS_TITLE_HELP},
...
static AVPMENU_ELEMENT AvPMenu_DifficultyLevelSelect[] =
{
	...
	{AVPMENU_ELEMENT_DIFFICULTYLEVEL, {TEXTSTRING_DIFFICULTY_IMPOSSIBLE},   {0},	{0},	{0},	TEXTSTRING_DIFFICULTY_IMPOSSIBLE_HELP},
	{AVPMENU_ELEMENT_ENDOFMENU}
};
...
static AVPMENU_ELEMENT AvPMenu_CheatOptions[] =
{
	...
	{AVPMENU_ELEMENT_CHEATCAMPAIGN, { TEXTSTRING_SINGLEPLAYER_CAMPAIGN }, { 0 }, { 0 }, { 0 } },
...
static AVPMENU_ELEMENT AvPMenu_Marine_GameType[] =
{
	{ AVPMENU_ELEMENT_GOTOMENU, { TEXTSTRING_LEVELSELECT_TITLE }, { AVPMENU_MARINELEVELS }, { 0 }, { 0 }, TEXTSTRING_MAINMENU_STARTSINGLEPLAYER_HELP },
	{ AVPMENU_ELEMENT_MARINECAMPAIGN, { TEXTSTRING_SINGLEPLAYER_CAMPAIGN }, { 0 }, { 0 }, { 0 }, TEXTSTRING_MAINMENU_STARTSINGLEPLAYER_HELP },
	{ AVPMENU_ELEMENT_MARINECUSTOMLEVEL, { TEXTSTRING_SINGLEPLAYER_CUSTOM }, { 0 }, { 0 }, { 0 }, TEXTSTRING_MAINMENU_STARTSINGLEPLAYER_HELP },
	{AVPMENU_ELEMENT_ENDOFMENU}
};

static AVPMENU_ELEMENT AvPMenu_Alien_GameType[] =
{
	{ AVPMENU_ELEMENT_GOTOMENU, { TEXTSTRING_LEVELSELECT_TITLE }, { AVPMENU_ALIENLEVELS }, { 0 }, { 0 }, TEXTSTRING_MAINMENU_STARTSINGLEPLAYER_HELP },
	{ AVPMENU_ELEMENT_ALIENCAMPAIGN, { TEXTSTRING_SINGLEPLAYER_CAMPAIGN }, { 0 }, { 0 }, { 0 }, TEXTSTRING_MAINMENU_STARTSINGLEPLAYER_HELP },
	{ AVPMENU_ELEMENT_ALIENCUSTOMLEVEL, { TEXTSTRING_SINGLEPLAYER_CUSTOM }, { 0 }, { 0 }, { 0 }, TEXTSTRING_MAINMENU_STARTSINGLEPLAYER_HELP },
	{AVPMENU_ELEMENT_ENDOFMENU}
};
static AVPMENU_ELEMENT AvPMenu_Predator_GameType[] =
{
	{ AVPMENU_ELEMENT_GOTOMENU, { TEXTSTRING_LEVELSELECT_TITLE }, { AVPMENU_PREDATORLEVELS }, { 0 }, { 0 }, TEXTSTRING_MAINMENU_STARTSINGLEPLAYER_HELP },
	{ AVPMENU_ELEMENT_PREDATORCAMPAIGN, { TEXTSTRING_SINGLEPLAYER_CAMPAIGN }, { 0 }, { 0 }, { 0 }, TEXTSTRING_MAINMENU_STARTSINGLEPLAYER_HELP },
	{ AVPMENU_ELEMENT_PREDATORCUSTOMLEVEL, { TEXTSTRING_SINGLEPLAYER_CUSTOM }, { 0 }, { 0 }, { 0 }, TEXTSTRING_MAINMENU_STARTSINGLEPLAYER_HELP },
	{AVPMENU_ELEMENT_ENDOFMENU}
};
static AVPMENU_ELEMENT AvPMenu_Achievements[] =
{
	{AVPMENU_ELEMENT_ACHIEVEMENT, { TEXTSTRING_ACHIEVEMENT_1 }, { 1 }, {&CurrentAchievement} , { 0 }, TEXTSTRING_ACHIEVEMENT1_HELP},
	{AVPMENU_ELEMENT_ENDOFMENU}
};

static AVPMENU_ELEMENT AvPMenu_BriefingCustom[] =
{
	{AVPMENU_ELEMENT_DIFFICULTYLEVEL, {TEXTSTRING_DIFFICULTY_EASY},	  {0},	{0},	{0},	TEXTSTRING_DIFFICULTY_EASY_HELP},
	{AVPMENU_ELEMENT_DIFFICULTYLEVEL, {TEXTSTRING_DIFFICULTY_MEDIUM}, {0},	{0},	{0},	TEXTSTRING_DIFFICULTY_MEDIUM_HELP},
	{AVPMENU_ELEMENT_DIFFICULTYLEVEL, {TEXTSTRING_DIFFICULTY_HARD},   {0},	{0},	{0},	TEXTSTRING_DIFFICULTY_HARD_HELP},
...
AVPMENU AvPMenusData[]=
{
	...
	// AVPMENU_MOUSECONTROLS
	{AVPMENU_FONT_SMALL,TEXTSTRING_MOUSECONTROLS_TITLE,			AvPMenu_MouseControlsOptions,		AVPMENU_CONTROLOPTIONS,	0},

	// AVPMENU_JOYSTICKCONTROLS
	{AVPMENU_FONT_SMALL,TEXTSTRING_JOYSTICKCONTROLS_TITLE,		AvPMenu_JoystickControlsOptions,	AVPMENU_CONTROLOPTIONS,	0},
	...
	{AVPMENU_FONT_SMALL,TEXTSTRING_MARINEKEYCONTROLS_TITLE,		AvPMenu_KeyConfig,				AVPMENU_CONTROLOPTIONS,	0},
	// AVPMENU_PREDATORKEYCONFIG
	{AVPMENU_FONT_SMALL,TEXTSTRING_PREDATORKEYCONTROLS_TITLE,	AvPMenu_KeyConfig,				AVPMENU_CONTROLOPTIONS,	0},
	// AVPMENU_ALIENKEYCONFIG
	{AVPMENU_FONT_SMALL,TEXTSTRING_ALIENKEYCONTROLS_TITLE,		AvPMenu_KeyConfig,				AVPMENU_CONTROLOPTIONS,	0},

	// AVPMENU_CONTROLOPTIONS
	{AVPMENU_FONT_BIG,TEXTSTRING_MAINMENU_GAMEPLAYOPTIONS,		AvPMenu_ControlOptions,			AVPMENU_MAIN,	0},
	...
	// AVPMENU_SKIRMISH_CONFIG_NOGOLD
	{ AVPMENU_FONT_SMALL,TEXTSTRING_MAINMENU_SKIRMISH,			AvPMenu_Skirmish_Config_NoGold,			AVPMENU_MULTIPLAYER_SKIRMISH,	0 },

	// AVPMENU_MARINE_GAMETYPE
	{ AVPMENU_FONT_BIG,	TEXTSTRING_MULTIPLAYER_MARINE,	AvPMenu_Marine_GameType,				AVPMENU_SINGLEPLAYER,	0 },

	// AVPMENU_ALIEN_GAMETYPE
	{ AVPMENU_FONT_BIG,	TEXTSTRING_MULTIPLAYER_ALIEN,	AvPMenu_Alien_GameType,					AVPMENU_SINGLEPLAYER,	0 },

	// AVPMENU_PREDATOR_GAMETYPE
	{ AVPMENU_FONT_BIG,	TEXTSTRING_MULTIPLAYER_PREDATOR,	AvPMenu_Predator_GameType,				AVPMENU_SINGLEPLAYER,	0 },

	// AVPMENU_ACHIEVEMENTS
	{ AVPMENU_FONT_BIG,	TEXTSTRING_MAINMENU_ACHIEVEMENTS,	AvPMenu_Achievements,				AVPMENU_MAIN,	0 },

	// AVPMENU_ALIEN_CUSTOM_LEVELS
	{ AVPMENU_FONT_BIG,	TEXTSTRING_MULTIPLAYER_ALIEN,	AvPMenu_Alien_Custom_Levels,					AVPMENU_SINGLEPLAYER,	0 },

	// AVPMENU_MARINE_CUSTOM_LEVELS
	{ AVPMENU_FONT_BIG,	TEXTSTRING_MULTIPLAYER_ALIEN,	AvPMenu_Marine_Custom_Levels,					AVPMENU_SINGLEPLAYER,	0 },

	// AVPMENU_PREDATOR_CUSTOM_LEVELS
	{ AVPMENU_FONT_BIG,	TEXTSTRING_MULTIPLAYER_ALIEN,	AvPMenu_Predator_Custom_Levels,					AVPMENU_SINGLEPLAYER,	0 },

	// AVPMENU_LEVELBRIEFING_CUSTOM
	{ AVPMENU_FONT_SMALL,TEXTSTRING_LEVELBRIEFING_TITLE,	AvPMenu_BriefingCustom, AVPMENU_MAIN, 0 },

	//AVPMENU_OPTIONS
	{ AVPMENU_FONT_BIG,	TEXTSTRING_MAINMENU_OPTIONS,	AvPMenu_Options,				AVPMENU_MAIN,	0 },
};
...
extern void MakePredatorKeyConfigMenu(void)
{
	...
	AvPMenu_KeyConfig[i+j].ElementID = AVPMENU_ELEMENT_KEYCONFIG;
	AvPMenu_KeyConfig[i+j].TextDescription = TEXTSTRING_INGAME_TRACKMODE;
	AvPMenu_KeyConfig[i+j].MenuToGoTo = AVPMENU_MAIN;
	AvPMenu_KeyConfig[i+j].HelpString = TEXTSTRING_KEYCONTROLS_HELP;
